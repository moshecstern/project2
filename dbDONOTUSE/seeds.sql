-- USE project2db;
-- INSERT INTO Coffees (type, name, flavor, company) VALUES("k-cups", "Double Donut Coffee","Bold", "NA");
-- INSERT INTO Coffees (type, name, flavor, company) VALUES("k-cups", "West Coast Roast", "Bold", "Guy Fieri");
-- INSERT INTO Coffees (type, name, flavor, company) VALUES("k-cups", "French Toast", "Sweet", "Java Factory Roasters");
-- INSERT INTO Coffees (type, name, flavor, company, caf) VALUES("k-cups", "Coconut Caramel-icious", "Sweet", "Crazy Cups", false);
-- INSERT INTO Coffees (type, name, flavor, company) VALUES("k-cups", "Chocolate Marshmallow Swirl", "Sweet", "Friendlys");
-- INSERT INTO Coffees (type, name, flavor, company) VALUES("k-cups", "Mint Chocolate", "Sweet", "Andes");
-- INSERT INTO Coffees (type, name, flavor, company) VALUES("k-cups", "Dark Roast", "Bold", "Entenmanns");
-- INSERT INTO Coffees (type, name, flavor, company) VALUES("k-cups", "Rocky Road", "Sweet", "Sundae Coffee");
-- INSERT INTO Coffees (type, name, flavor, company) VALUES("k-cups", "Maple Sleigh", "Sweet", "Brooklyn Bean Roastery");
